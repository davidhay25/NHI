...
* codes from system https://standards.digital.health.nz/fhir/cs/addressnotvalidatedreason

CodeSystem: AddressNotValidated
Title: "Address Not Validated reason"
Description: "The reason why the address was not validated"
* ^url = https://standards.digital.health.nz/fhir/cs/addressnotvalidatedreason
